...
import coffee1 from './assets/787Coffee.jpg';
import coffee2 from './assets/CultureEspresso.jpg';
import coffee3 from './assets/SaltwaterCoffee.jpg';
import coffee4 from './assets/Bird&Branch.jpg';
import coffee5 from './assets/ThinkCoffee.jpg';
import coffee6 from './assets/EverymanEspresso.jpg';
import coffee7 from './assets/GregorysCoffee.jpg';
import coffee8 from './assets/StKildaCoffee.jpg';
import coffee9 from './assets/GroundSupportCafe.jpg';
import coffee10 from './assets/BlackPressCoffee.jpg';

const App = () => {
  return (
    <div className="App">
      <header>
        <h1 className='heading'>Coffee Shops in NYC</h1>
      </header>
